...
## set java path
if [ -z "$JAVA" ] ; then
  JAVA="/Users/ds/Library/Java/JavaVirtualMachines/azul-17.0.6-x86/Contents/Home/bin/java"
fi
...
# jdk17删除 -XX:+AggressiveOpts -XX:-UseBiasedLocking
JAVA_OPTS="$JAVA_OPTS -Xss256k  -XX:-OmitStackTraceInFastThrow -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=$base/logs"
